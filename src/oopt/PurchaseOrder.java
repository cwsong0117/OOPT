...
//setter
    ...
    public static void addPurchaseOrderMenu() {
        ...
        System.out.println("Any key to break");
            ...
            case 1:
                ...
                for (Supplier j : suppliers) {
                    if (j.getID().charAt(0) == 'I') {
                        ...
                        if (supplierHasStock) {
                            System.out.println("Supplier ID: " + j.getID());
        ...
        do {
            ...
            if (valid) {
                ...
                System.out.println("Invalid supplier id...Any key to try again or Type 'XXX' to quit and the purchase order will be cancel");
                System.out.print("XXX or Any key:");
    ...
    do {
        ...
        for (Stock i : stocks) {
            if (i.getStockID().equals(itemId) && i.getSupplier().equals(relevant)) {
                ...
                System.out.print("Any more items to add? (yes/no): ");
                continueAdd = scan.nextLine();
    ...
    if (found) {
        ...
        do {
            ...
            do {
                System.out.print("Enter staff password (or type 'XXX' to quit): ");
